...
public class CopyOfClientUserModeActivity extends Activity {
	...
	private class GrabURL extends AsyncTask<String, Void, String> {
		...
		private ProgressDialog dialog = new ProgressDialog(
				CopyOfClientUserModeActivity.this);
		...
		protected void onCancelled() {
			dialog.dismiss();
			Toast toast = Toast.makeText(CopyOfClientUserModeActivity.this,
		...
		protected void onPostExecute(String content) {
			...
			Toast toast;
			if (error) {
				toast = Toast.makeText(CopyOfClientUserModeActivity.this, content,
						Toast.LENGTH_LONG);
				toast.setGravity(Gravity.TOP, 25, 400);
				toast.show();
			} else {
